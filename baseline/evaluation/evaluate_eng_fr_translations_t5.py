...
# === Input files
input_files = {
    "t5": BASE_DIR / "generated_translations_t5_baseline.csv",
}

# === Columns containing generated translations
generated_columns = [
    "generated_translation_fr",
]

# === Reference columns
ref_names = ["french_segond", "french_crampon", "french_darby"]
