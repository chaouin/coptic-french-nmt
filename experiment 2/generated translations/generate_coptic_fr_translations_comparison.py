...
# === Fonction unique pour générer une traduction ===
...
for file_label, input_path in input_files.items():
    ...
    # --- Opus finetune copte -> FR ---
    print("🚀 Opus finetune copte -> FR")
    translations = []
    ...
    # --- T5 finetune copte -> FR ---
    print("🚀 T5 finetune copte -> FR")
    translations = []
    ...
    # --- Hiero finetune copte -> FR ---
    print("🚀 Hiero finetune copte -> FR")
    translations = []
