...
# === MAPPINGS POUR 1 CORINTHIANS ===
BOOK_ID_MAP_1COR = {"58": "Hebrews"}
...
def merge_with_french_versions(coptic_data, segond_csv, darby_csv, crampon_csv):
    ...
    print(f"✅ Fichier final généré : hebrews_coptic_3versions.csv ({len(merged)} lignes)")

# === MAIN ===
if __name__ == "__main__":
    print("=== Extraction du corpus copte pour Hebrews ===")
    data_1cor = process_book("chapters")

    # Ici tu peux fournir tes CSV alignés sur verse_id
