...
substitution_prob = 0.1  # proba confusion
deletion_prob = 0.02     # proba suppression
swap_prob = 0.02         # proba inversion

# ===== Dictionnaire de confusion pour texte romanisé =====
confusion_map = {
    'a': ['o', 'e'],
    'o': ['a', 'e'],
    'e': ['a', 'o'],
...
# ===== Génération des différents jeux bruités =====
for label, noise_prob in noise_settings.items():
    ...
    print(f"=== Bruitage {label}% terminé ===")
    print(f"Nombre total de versets : {len(df)}")
    print(f"Nombre de versets bruités : {nb_noisy}")
