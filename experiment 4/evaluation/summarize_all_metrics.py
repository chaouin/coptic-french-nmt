...
for csv_file in csv_files:
    ...
    # === Extraire le dataset à partir du début du nom du fichier
...
# === Tableau détaillé par dataset (non fusionné)
...
# === Identification des best/worst datasets par modèle/métrique (sans fusion)
best_worst_rows = []
